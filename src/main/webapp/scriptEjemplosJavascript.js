...
countryHandle.onchange = function () {
    // cities es un arreglo (vector) asociativo, aquel
    //  cuyos índices son cadenas en vez de enteros.
    // y el contenido de una entrada es un vector de cadenas de caracteres
    var cities = {
